...
import esm_one_hot
from esm_one_hot.model.esm2 import ESM2
...
def _load_model_and_alphabet_core_v1(model_data):
    import esm_one_hot # since esm_one_hot.inverse_folding is imported below, you actually have to re-import esm here

    alphabet = esm_one_hot.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = esm_one_hot.ProteinBertModel
        ...
        model_type = esm_one_hot.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        import esm_one_hot.inverse_folding

        model_type = esm_one_hot.inverse_folding.gvp_transformer.GVPTransformerModel
...
def _load_model_and_alphabet_core_v2(model_data):
    ...
    alphabet = esm_one_hot.data.Alphabet.from_architecture("ESM-1b")
    model = ESM2(
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: esm_one_hot.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
